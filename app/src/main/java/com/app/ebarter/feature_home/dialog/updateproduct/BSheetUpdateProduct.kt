...
class BSheetUpdateProduct : BottomSheetDialogFragment() {
    ...
    private val cameraActivityResultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK) {
            model.filePathUri = (ivProduct.tag as Uri).toString()
    ...
    private fun onsetViews() {
        teDescription.setText(model.description)
        teCategory.setText(model.category)
        teNumber.setText(model.phone)
        teLocation.setText(model.location)
        teReason.setText(model.reason)
        teDetails.setText(model.details)
        tePayment.setText(model.payment)
        Picasso.get().load(model.imageLink).placeholder(R.drawable.ic_placeholder).into(ivProduct)
        ...
        btnPost.setOnClickListener {
            ...
            val payment = binding.tePayment.text.toString().trim()
            ...
            if (description.isNotEmpty()
                ...
                val data = Data.Builder()
                    ...
                    .build()
                request =
                    OneTimeWorkRequest.Builder(UpdateProductWorker::class.java)
                        .setInputData(data)
                        .build()
    ...
    companion object {
        private const val POST_WORK_TAG = "UpdateProductWork"
    }
}