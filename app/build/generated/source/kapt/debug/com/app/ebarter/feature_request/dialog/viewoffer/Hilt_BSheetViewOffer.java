...
public abstract class Hilt_BSheetViewOffer extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BSheetViewOffer() {
    super();
  }

  Hilt_BSheetViewOffer(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BSheetViewOffer_GeneratedInjector) this.generatedComponent()).injectBSheetViewOffer(UnsafeCasts.<BSheetViewOffer>unsafeCast(this));
    }
  }
