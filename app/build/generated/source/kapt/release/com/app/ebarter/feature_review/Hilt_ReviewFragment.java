...
public abstract class Hilt_ReviewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReviewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReviewFragment_GeneratedInjector) this.generatedComponent()).injectReviewFragment(UnsafeCasts.<ReviewFragment>unsafeCast(this));
    }
  }
