...
public abstract class Hilt_BSheetAddProduct extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BSheetAddProduct() {
    super();
  }

  Hilt_BSheetAddProduct(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BSheetAddProduct_GeneratedInjector) this.generatedComponent()).injectBSheetAddProduct(UnsafeCasts.<BSheetAddProduct>unsafeCast(this));
    }
  }
